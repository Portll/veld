...
mod zenoh_embed_tests {
    ...
    fn test_config_from_env_defaults() {
        ...
        std::env::remove_var("VELD_ZENOH_EMBED_PREFIX");
        std::env::remove_var("VELD_ZENOH_EMBED_MODEL");
        std::env::remove_var("VELD_ZENOH_EMBED_DIMENSION");
        std::env::remove_var("VELD_ZENOH_EMBED_TIMEOUT_MS");
        std::env::remove_var("VELD_ZENOH_CONNECT");
        std::env::remove_var("VELD_ZENOH_API_KEY");
    ...
    fn test_config_from_env_overrides() {
        std::env::set_var("VELD_ZENOH_EMBED_PREFIX", "mybot");
        std::env::set_var("VELD_ZENOH_EMBED_MODEL", "bge-small-en");
        std::env::set_var("VELD_ZENOH_EMBED_DIMENSION", "768");
        std::env::set_var("VELD_ZENOH_EMBED_TIMEOUT_MS", "2000");
        std::env::set_var("VELD_ZENOH_CONNECT", "tcp/10.0.0.1:7447,tcp/10.0.0.2:7447");
        std::env::set_var("VELD_ZENOH_API_KEY", "secret");
