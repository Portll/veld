...
fn create_linear_issue() -> LinearIssueData {
    LinearIssueData {
        ...
        assignee: Some(LinearUser {
            ...
            name: Some("Private Citizen".to_string()),
        ...
        completed_at: None,
        canceled_at: None,
        url: Some("https://linear.app/veld/issue/SHO-42".to_string()),
    }
}
...
fn create_github_pr() -> GitHubPullRequest {
    GitHubPullRequest {
        ...
        body: Some(
            "## Summary\n\
            Adds comprehensive GitHub integration for syncing issues and PRs to Veld memory.\n\n\
            ## Changes\n\
...
fn create_linear_webhook_payload() -> String {
    serde_json::json!({
        ...
        "url": "https://linear.app/veld/issue/SHO-42"
    })
    .to_string()
}
