...
<p align="center">
  <a href="https://registry.modelcontextprotocol.io/servers/io.github.Portll/veld"><img src="https://img.shields.io/badge/MCP-Registry-green" alt="MCP Registry"></a>
...
from veld.integrations.langchain import VeldMemory
...
```python
from veld.integrations.llamaindex import VeldLlamaMemory

memory = VeldLlamaMemory(
    server_url="http://localhost:3030",
    user_id="agent-1",
    api_key="your-key"
)
...
```
VELD_PORT=3030                    # Default: 3030
VELD_MEMORY_PATH=./data           # Default: ./veld_data
VELD_API_KEYS=key1,key2           # Required in production
VELD_MAINTENANCE_INTERVAL=300     # Decay cycle (seconds)
VELD_ACTIVATION_DECAY=0.95        # Decay factor per cycle
```
...
[MCP Registry](https://registry.modelcontextprotocol.io/servers/io.github.Portll/veld) · [PyPI](https://pypi.org/project/veld/) · [npm](https://www.npmjs.com/package/@veld/memory-mcp) · [GitHub](https://github.com/Portll/veld)
