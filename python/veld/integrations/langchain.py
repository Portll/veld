...
class VeldMemory(BaseMemory):
    ...
    Attributes:
        ...
        memory_key: Key used in chain's memory dict (default: "veld_context")
    ...
    memory_key: str = Field(default="veld_context")
    ...
    def __init__(self, **kwargs):
        ...
        if self.api_key is None:
            self.api_key = os.environ.get("VELD_API_KEY")
