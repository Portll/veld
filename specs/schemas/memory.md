...
Human-readable documentation for the unified VELD Memory schema.
...
|----------------|-------|------------|
| veld | MiniLM-L6-v2 | 384 |
| veld-cloudflare | bge-small-en-v1.5 | 384 |
...
| Field | veld | veld-cloudflare | mcp-memory-service |
|-------|--------------|------------------|-------------------|
