...
export async function getProactiveContext(
  ...
  try {
    ...
    const response = await fetch(
      `${config.veld.apiUrl}/api/proactive_context`,
      {
        method: "POST",
        headers: {
...
export async function remember(
  ...
  try {
    const response = await fetch(`${config.veld.apiUrl}/api/remember`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "X-API-Key": config.veld.apiKey,
...
export async function recall(userId: string, query: string): Promise<string> {
  try {
    const response = await fetch(`${config.veld.apiUrl}/api/recall`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "X-API-Key": config.veld.apiKey,
...
export async function getContextSummary(userId: string): Promise<string> {
  try {
    const response = await fetch(`${config.veld.apiUrl}/api/context_summary`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "X-API-Key": config.veld.apiKey,
