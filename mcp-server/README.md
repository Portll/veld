...
<p align="center">
  <strong>v0.7.6</strong> | Persistent cognitive memory for AI agents
</p>

<p align="center">
  <a href="https://www.npmjs.com/package/@veld/memory-mcp"><img src="https://img.shields.io/npm/v/@veld/memory-mcp" alt="npm"></a>
  <a href="https://github.com/Portll/veld/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-Apache--2.0-blue" alt="License"></a>
</p>

<p align="center">
  <a href="https://www.veld-rag.com/memory">Documentation</a> |
  <a href="https://github.com/Portll/veld">GitHub</a> |
  <a href="https://pypi.org/project/veld/">Python SDK</a> |
  <a href="https://crates.io/crates/veld">Rust Crate</a>
</p>

---

Product name: `Veld - Agentic Memory`. Published MCP package: `@veld/memory-mcp`.
...
```json
{
  "mcpServers": {
    "veld": {
      ...
      "env": {
        "VELD_API_KEY": "your-api-key-here"
      }
    }
  }
}
...
command = "npx"
args = ["-y", "@veld/memory-mcp"]
env = { VELD_API_KEY = "your-api-key-here" }
```
...
To build from source and point your client at the local build instead of `npx`:
...
|----------|-------------|---------|
| `VELD_API_KEY` | **Required**. API key for authentication | - |
| `VELD_API_URL` | Backend server URL | `http://127.0.0.1:3030` |
| `VELD_USER_ID` | User ID for memory isolation | `claude-code` |
| `VELD_NO_AUTO_SPAWN` | Set to `true` to disable auto-starting the backend | `false` |
| `VELD_STREAM` | Enable/disable streaming ingestion | `true` |
| `VELD_PROACTIVE` | Enable/disable proactive memory surfacing | `true` |
...
1. **Install**: `npx -y @veld/memory-mcp` downloads the package
...
- **Python SDK**: `pip install veld` - last published Python package line
- **Rust Crate**: `cargo add veld` - last published crate line

## Links

- [Documentation](https://www.veld-rag.com/memory)
