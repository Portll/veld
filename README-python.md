...
Product name: `Veld - Agentic Memory`. Published package name: `veld`.
...
memory = VeldMemory(storage_path="./langchain_data")
```
...
memory = VeldLlamaMemory(storage_path="./llamaindex_data")
```
...
- [crates.io (Rust)](https://crates.io/crates/veld)
