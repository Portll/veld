...
Usage:
    from veld_spot_bridge import SpotMemoryBridge
...
class SpotMemoryBridge:
    ...
    # =========================================================================
    # Type conversions: Simulated Spot types -> veld
    # =========================================================================

    @staticmethod
    def se3pose_to_position(pose: SE3Pose) -> Position:
        """Convert Spot's SE3Pose to veld Position (extracts translation)."""
        return Position(
    ...
    def vec3_to_position(vec: Vec3) -> Position:
        """Convert Spot's Vec3 to veld Position."""
    ...
    def gps_to_geolocation(latitude: float, longitude: float, altitude: float = 0.0) -> GeoLocation:
        """Convert GPS coordinates to veld GeoLocation."""
    ...
    def robot_state_to_environment(state: RobotState) -> Environment:
        """Convert Spot's RobotState to veld Environment."""
        return Environment(
    ...
    def navigation_result_to_outcome(feedback: NavigationFeedbackResponse) -> Outcome:
        """Convert navigation feedback to veld Outcome."""
        status_map = {
    ...
    # =========================================================================
    # Type conversions: Real Spot SDK protobufs -> veld
    # =========================================================================

    @staticmethod
    def se3pose_from_proto(proto_pose: Any) -> Position:
        """Convert a real bosdyn.api.geometry_pb2.SE3Pose to veld Position.
    ...
    def persist_world_object_from_real_proto(self, proto_obj: Any) -> str:
        """Persist a real bosdyn.api.WorldObject protobuf to veld.
    ...
    def nav_feedback_from_proto(self, proto_feedback: Any) -> Outcome:
        """Convert a real NavigationFeedbackResponse protobuf to veld Outcome.
    ...
    def robot_state_from_proto(self, proto_state: Any) -> Environment:
        """Convert a real bosdyn.api.RobotState protobuf to veld Environment.
    ...
    def waypoint_from_proto(self, proto_waypoint: Any) -> str:
        """Persist a real GraphNav Waypoint protobuf to veld.
