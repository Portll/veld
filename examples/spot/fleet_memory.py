...
storage_path sequentially (RocksDB requires exclusive access).
    ...
    from veld.client import VeldClient
    alpha = VeldClient(base_url="http://fleet-server:3030", user_id="fleet")
    beta  = VeldClient(base_url="http://fleet-server:3030", user_id="fleet")
