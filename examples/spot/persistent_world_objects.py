...
def run_demo():
    ...
    veld_objects = bridge.recall_world_objects(limit=10)

    print()
    print(f"  Spot native:  {len(spot_objects)} objects (within 15-sec TTL)")
    print(f"  Veld: {len(veld_objects)} objects (permanent)")
    ...
    veld_objects_after = bridge.recall_world_objects(limit=10)

    print(f"  Spot native:  {len(spot_objects_after)} objects (all expired)")
    print(f"  Veld: {len(veld_objects_after)} objects (all retained)")
    ...
    print(f"    Veld: {len(veld_objects_after)} objects")
    print()
    print("  Cross-mission:")
