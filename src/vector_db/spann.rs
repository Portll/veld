...
impl SpannIndex {
    ...
    pub fn search(&self, query: &[f32], k: usize) -> Result<Vec<(u32, f32)>> {
        ...
        // Tie-break by partition index keeps probe selection deterministic across runs (RH-10).
        ...
        // Convert heap to sorted results (smallest distance first), tie-break by id (RH-10)
