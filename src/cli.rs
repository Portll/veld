...
fn handle_init() -> Result<()> {
    ...
    eprintln!();
    eprintln!("    claude mcp add veld -- npx -y @veld/memory-mcp");
    eprintln!();
    eprintln!("  Documentation: https://www.veld.com/docs");
    eprintln!();
...
fn handle_doctor() -> Result<()> {
    ...
    // 4. Port availability
    let port: u16 = std::env::var("VELD_PORT")
        .ok()
