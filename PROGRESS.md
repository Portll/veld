...
**Current Branch**: v0.7.7 | First packaged release — repo moved to portll/veld, CI added, track toward v0.8
...
- [x] Build number auto-increment (build.rs + VELD_VERSION_FULL)
