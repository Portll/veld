<p align="center">
  <img src="https://raw.githubusercontent.com/Portll/veld/main/assets/logo.png" width="120" alt="Veld - Agentic Memory">
</p>
...
<p align="center">
  <a href="https://github.com/Portll/veld/actions"><img src="https://github.com/Portll/veld/workflows/CI/badge.svg" alt="build"></a>
  <a href="https://registry.modelcontextprotocol.io/v0/servers?search=veld"><img src="https://img.shields.io/badge/MCP-Registry-green" alt="MCP Registry"></a>
  <a href="https://cursor.directory/plugins/veld-1"><img src="https://img.shields.io/badge/Cursor-Directory-black?logo=cursor" alt="Cursor Directory"></a>
  <a href="https://crates.io/crates/veld"><img src="https://img.shields.io/crates/v/veld.svg" alt="crates.io"></a>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Portll/veld/main/assets/Veld_preview.gif" width="800" alt="Veld - Agentic Memory Demo — Claude Code with persistent memory and TUI dashboard">
</p>
...
`Veld - Agentic Memory` is the product name. The current published package IDs and binaries remain `veld`, `@veld/memory-mcp`, and `veld` while registry surfaces catch up.
...
```bash
# Download from GitHub Releases (or, for the last public release line only, brew tap Portll/veld && brew install veld)
...
```bash
# 1. Start the server
docker run -d -p 3030:3030 -v veld-data:/data varunveld/veld
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Portll/veld/main/assets/recall.png" width="700" alt="Veld Recall">
</p>

<p align="center"><i>Semantic recall with hybrid search — relevance scores, memory tiers, and activity feed</i></p>

<p align="center">
  <img src="https://raw.githubusercontent.com/Portll/veld/main/assets/projects-todos.jpg" width="700" alt="Veld Projects & Todos">
</p>
...
[Full API reference →](https://www.veld.com/docs/api)
...
```bash
VELD_ENV=production              # Production mode
VELD_API_KEYS=key1,key2,key3     # Comma-separated API keys
VELD_ENCRYPTION_KEY=<32-byte-key> # Required if you want encrypted memory content at rest
VELD_HOST=127.0.0.1              # Bind address (default: localhost)
VELD_PORT=3030                   # Port (default: 3030)
VELD_MEMORY_PATH=/var/lib/veld  # Data directory
VELD_REQUEST_TIMEOUT=60          # Request timeout in seconds
VELD_MAX_CONCURRENT=200          # Max concurrent requests
VELD_RATE_LIMIT=4000             # Enabled by default in production unless explicitly set to 0
VELD_CORS_ORIGINS=https://app.example.com
```

`VELD_CORS_ORIGINS` is required for browser access in production. If it is missing, the server will reject all cross-origin requests until you configure it.
</details>
...
services:
  veld:
    image: varunveld/veld:latest
    environment:
      - VELD_ENV=production
      - VELD_HOST=0.0.0.0
      - VELD_API_KEYS=${VELD_API_KEYS}
    volumes:
      - veld-data:/data
    networks:
      - internal
...
|---------|-------------|--------|
| [VELD on Cloudflare](https://github.com/doobidoo/veld-cloudflare) | Edge-native implementation on Cloudflare Workers | [@doobidoo](https://github.com/doobidoo) |
...
<p align="center">
  <a href="https://registry.modelcontextprotocol.io/v0/servers?search=veld">MCP Registry</a> · <a href="https://hub.docker.com/r/varunveld/veld">Docker Hub</a> · <a href="https://pypi.org/project/veld/">PyPI</a> · <a href="https://www.npmjs.com/package/@veld/memory-mcp">npm</a> · <a href="https://crates.io/crates/veld">crates.io</a> · <a href="https://www.veld.com">Docs</a>
</p>
