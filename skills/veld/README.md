...
This skill is branded as Veld - Agentic Memory. Current install and directory identifiers still use `veld`.
...
### With Claude Code
```bash
claude mcp add veld -- npx -y @anthropic-ai/veld
```

Or add the skill directly:
```bash
# Copy the SKILL.md to your skills directory
cp SKILL.md ~/.claude/skills/veld/SKILL.md
```
...
- [GitHub Repository](https://github.com/roshera/veld)
- [Documentation](https://veld.dev/docs)
- [MCP Server on npm](https://www.npmjs.com/package/@anthropic-ai/veld)
